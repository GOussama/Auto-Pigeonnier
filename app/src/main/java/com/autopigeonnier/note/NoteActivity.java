...
//			// Mobile Service URL and key
     ...
     *            The item to mark
     */
    public void checkItem(final Note item) {
...
//		End of lines to comment out
    ...
    public void addNewActivity(View view){
        Intent intent = new Intent(NoteActivity.this, com.autopigeonnier.note.AddNoteActivity.class);
    ...
    public void addItem(View view) {
        ...
        item.setmTitle(mTextNewToDo.getText().toString());
        //item.setComplete(false);
        item.setmBody("Mytitle");
...
//		// Get the items that weren't marked as completed and add them in the adapter
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    final MobileServiceList<Note> result = mNoteTable.execute().get();
                    runOnUiThread(new Runnable() {

                        @Override
                        public void run() {
                            mAdapter.clear();
                            for (Note item : result) {
                                mAdapter.add(item);
                            }
                        }
                    });
...
//L'URL : https://auto-pigeon.azure-mobile.net/
//Application key : jNOWwXrhBrLdoFqxTsBrvJvolenbJP52

//Google authent
//client ID : 443105632558-7k19j7ct6kun4eqqf6j6sqi1uctjigdu.apps.googleusercontent.com
//client secret : DgHu9UsP2E7K725OiXPq-S1G
